...
interface AirportsService {
    ...
    @POST("/api/airports")
    suspend fun postAirport(@Body airportRequest: AirportRequest): ApiResponse1<CreatedResponse>
    ...
    suspend fun deleteAirport(@Path("airportId") airportId: String): ApiResponse1<Void>
