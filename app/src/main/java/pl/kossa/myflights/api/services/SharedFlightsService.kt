...
interface SharedFlightsService {
    ...
    suspend fun joinSharedFlight(@Path("sharedFlightId") sharedFlightId: String): ApiResponse1<Void>
    ...
    suspend fun getSharedFlightJoinDetails(@Path("sharedFlightId") sharedFlightId: String): ApiResponse1<SharedFlightJoinDetails>
}